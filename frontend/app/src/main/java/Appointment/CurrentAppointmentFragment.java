 ...
 * Use the {@link CurrentAppointmentFragment#newInstance} factory method to
...
public class CurrentAppointmentFragment extends Fragment {
     ...
     * @return A new instance of fragment CurrentAppointmentFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CurrentAppointmentFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        apiInterface.getAllPreviousBookings(GlobalVariables.loggedInUser.getUserID()).enqueue(new Callback<List<AppointmentModel>>() {
            @Override
        ...
        return inflater.inflate(R.layout.fragment_current_appointment, container, false);
    }
        ...
        for (String nd : noDuplicates) {
            ...
            for (AppointmentModel ap : appModel) {
                if (nd.equals(ap.getBookingInfo().getDate().substring(0,10))) {
                    ...
                    SubItem subItem = new SubItem(info1+ ap.getPatientName(), info2 + ap.getBookingInfo().getType(),
                            info3 +startTime + " - "+ endTime,bookingID,ap.getBookingInfo().getDate().toString(),ap.getBookingInfo().getCancelled(),
                            ap.getBookingInfo().getType());
