 ...
 * Use the {@link UpcomingAppointmentFragment#newInstance} factory method to
...
public class UpcomingAppointmentFragment extends Fragment {
    ...
    private static final String TAG ="Testing Upcoming" ;
    ...
    public static UpcomingAppointmentFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        apiInterface.getAllUpcomingBookings(GlobalVariables.loggedInUser.getUserID()).enqueue(new Callback<List<AppointmentModel>>() {
            @Override
        ...
        for (String nd : noDuplicates) {
            ...
            for (AppointmentModel ap : appModel) {
                if (nd.equals(ap.getBookingInfo().getDate().substring(0,10))) {
                    ...
                    SubItem subItem = new SubItem(info1+ ap.getPatientName(), info2 + ap.getBookingInfo().getType(), info3 +startTime + " - "+ endTime,bookingID,ap.getBookingInfo().getDate().toString(),ap.getBookingInfo().getCancelled(),
