...
public class GuardianRegistersChild1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guardian_registers_child1);

        btnNext = findViewById(R.id.GCRegbtnChildRegisterNext2);
        txtChildName = findViewById(R.id.GCRegtxtChildName2);
        imgPrev = findViewById(R.id.GCRegimgbtnPrev);
        txtAlreadySigned = findViewById(R.id.GCRegtxtAlreadySigned);
        email = findViewById(R.id.GCRegtxtChildEmail);
        ...
        txtAlreadySigned.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(GuardianRegistersChild1.this, ChildLogInRedesign1.class);
                startActivity(i);
...
//        });
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(GuardianRegistersChild1.this,"Make sure all entries are filled", Toast.LENGTH_LONG).show();
                }else
                {
                    if(isValidEmailAddress(email.getText().toString()) == false){
                        Toast.makeText(GuardianRegistersChild1.this,"Please make sure you entered valied email address", Toast.LENGTH_LONG).show();
                    }else {
                        ...
                        Intent i = new Intent(GuardianRegistersChild1.this, GuardianRegistersChild3.class);
                        startActivity(i);
                        overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                    }
                }
        ...
        viewPager2 = findViewById(R.id.GCRegviewPagerImageSlider2Child);
        ...
        GuardianRegistersChild1.PageListener pageListener =  new GuardianRegistersChild1.PageListener();
