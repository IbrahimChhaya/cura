...
public class UserBookings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView booking = (TextView) findViewById(R.id.bookingText);
      ...
      /*  TextView date1 = (TextView) findViewById(R.id.lblDate);
        ...
        apiInterface.getuserBookings(ID).enqueue(new Callback<List<BookingModel>>() {
            ...
            public void onFailure(Call<List<BookingModel>> call, Throwable t) {
                Toast.makeText(UserBookings.this, t.getLocalizedMessage(),Toast.LENGTH_LONG).show();
            }
        });
