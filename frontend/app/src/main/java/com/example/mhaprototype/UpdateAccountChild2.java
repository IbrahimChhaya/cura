...
public class UpdateAccountChild2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_account_child2);

        animalViewPager = (ViewPager2) findViewById(R.id.animalViewPager);
        setupViewPager(animalViewPager, "animal");
        UpdateAccountChild2.PageListener pageListener = new UpdateAccountChild2.PageListener("animal");
        ...
        pageListener = new UpdateAccountChild2.PageListener("food");
        ...
        pageListener = new UpdateAccountChild2.PageListener("color");
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hashMap.put("userID", GlobalVariables.userID);
                hashMap.put("oldPassword", password);
                hashMap.put("NewPassword", password);
                hashMap.put("newStatus", "Active");
                hashMap.put("newName", GlobalVariables.name);
                hashMap.put("oldEmail", email);
                hashMap.put("newEmail", email);
                hashMap.put("newDOB", GlobalVariables.birthDate + "T00:00:00");
                ...
                apiInterface.UpdateGuardianEmail("application/json; charset=utf-8", hashMap).enqueue(new Callback() {
                    @Override
                    public void onResponse(Call call, Response response) {
                        if (response.code() == 200) {
                            ...
                            try {
                                ...
                                UserModel regModel = new UserModel(gsonObject);
                            ...
                            Toast.makeText(UpdateAccountChild2.this,"Updated Successfully", Toast.LENGTH_LONG).show();


                        } else {
                            Toast.makeText(UpdateAccountChild2.this, response.errorBody().toString(), Toast.LENGTH_LONG).show();
