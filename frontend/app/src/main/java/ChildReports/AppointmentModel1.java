...
public class AppointmentModel1 {
    @SerializedName("bookingInfo")
    @Expose
    private BookingModel3 bookingInfo;

    @SerializedName("patientName")
    @Expose
    private String patientName;

    public BookingModel3 getBookingInfo() {
        return bookingInfo;
    }

    public void setBookingInfo(BookingModel3 bookingInfo) {
...
class BookingModel3 {
    ...
    public void setTime(Time3 timeObject) {
